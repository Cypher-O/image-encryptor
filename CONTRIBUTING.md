# Contributing to Secure Image-Encryptor App

First of all, thank you for considering contributing to the Secure Image-Encryptor App! Contributions from developers like you are what make this project great.
...
If you encounter a bug in the application or have a feature request, please open an issue on the [issue tracker](https://github.com/Cypher-O/image-encryptor/issues). When reporting bugs, please include steps to reproduce the issue and any relevant details about your environment.
...
By contributing to the Secure Image-Encryptor App, you agree that your contributions will be licensed under the MIT License. See the [LICENSE](LICENSE) file for details.
